//
//  NewInputCodeViewController.swift
//  QRLocation
//
...
class NewInputCodeViewController: UIViewController, UITextFieldDelegate, CLLocationManagerDelegate, SecurityGuardAlertViewDelegate {
...
//            self.birthdayTextField.textColor = UIColor.blueColor()
        }
        
        if(self.observing == false) {
            
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(NewInputCodeViewController.keyboardWillShow(_:)), name: UIKeyboardWillShowNotification, object: nil)
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(NewInputCodeViewController.keyboardWillHide(_:)), name: UIKeyboardWillHideNotification, object: nil)
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(NewInputCodeViewController.enterForeground(_:)), name:"applicationWillEnterForeground", object: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?){
        ...
        if(segue.identifier == "FromNewInputCodeViewControllerToNewDatePickerViewControllerModal") {
            
            let newDatePickerViewController : NewDatePickerViewController = segue.destinationViewController as! NewDatePickerViewController
            newDatePickerViewController.newInputCodeViewController = self
    ...
    func textFieldShouldBeginEditing(textField: UITextField) -> Bool {
        ...
        if(textField == self.birthdayTextField) {
            ...
            self.performSegueWithIdentifier("FromNewInputCodeViewControllerToNewDatePickerViewControllerModal", sender: self)
