//
//  NewReadQRCodeViewController.swift
//  QRLocation
//
...
class NewReadQRCodeViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, CLLocationManagerDelegate, SecurityGuardAlertViewDelegate {
    ...
    @IBAction func inputCodeButtonTapped(sender:AnyObject) {
        ...
        self.performSegueWithIdentifier("FromNewReadQRCodeViewControllerToNewInputCodeViewControllerModal", sender: self)
